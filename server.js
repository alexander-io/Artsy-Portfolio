...
app.get('fonts/roboto/Roboto-Medium.woff', function(req, res) {
  res.sendFile(__dirname + '/node_modules/materialize-css/dist/fonts/roboto/Roboto-Medium.woff')
})

app.get('fonts/roboto/Roboto-Medium.woff2', function(req, res) {
  res.sendFile(__dirname + '/node_modules/materialize-css/dist/fonts/roboto/Roboto-Medium.woff2')
})
